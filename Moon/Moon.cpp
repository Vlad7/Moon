...
// Moon.cpp
// ==========
// Moon for OpenGL with (radius, sectors, stacks)
...
// ctor
///////////////////////////////////////////////////////////////////////////////
Moon::Moon(float radius, int sectors, int stacks, bool smooth, int up) : interleavedStride(32)
{
...
// setters
///////////////////////////////////////////////////////////////////////////////
void Moon::set(float radius, int sectors, int stacks, bool smooth, int up)
{
    if(radius > 0)
        this->radius = radius;
...
///////////////////////////////////////////////////////////////////////////////
// draw a moon in VertexArray mode
...
///////////////////////////////////////////////////////////////////////////////
void Moon::drawLines(const float lineColor[4]) const
{
    // set line colour
...
// the caller must set the line width before call this
///////////////////////////////////////////////////////////////////////////////
void Moon::drawWithLines(const float lineColor[4]) const
{
...
// x = xø + R(v/45 gradusov)^2 r
// y = yø
// z = 2 * zø
// where v: stack(latitude) angle (-90 <= v <= 90)
//       u: sector(longitude) angle (0 <= u <= 360)
///////////////////////////////////////////////////////////////////////////////
void Moon::buildVerticesSmooth()
{
    const float R = 1;
    ...
    for (int i = 0; i <= stackCount; ++i)
    {
        ...
        z = 2 * radius * sinf(stackAngle);              // 2 * r * sin(u)
        ...
        for (int j = 0; j <= sectorCount; ++j)
        {
            ...
            // vertex position
            x = xy * cosf(sectorAngle) + R * (stackAngle / (PI / 4)) * (stackAngle / (PI / 4));             // r * cos(u) * cos(v)
...
///////////////////////////////////////////////////////////////////////////////
void Moon::buildInterleavedVertices()
{
...
///////////////////////////////////////////////////////////////////////////////
void Moon::changeUpAxis(int from, int to)
{
...
///////////////////////////////////////////////////////////////////////////////
void Moon::addVertex(float x, float y, float z)
{
...
///////////////////////////////////////////////////////////////////////////////
void Moon::addNormal(float nx, float ny, float nz)
{
...
///////////////////////////////////////////////////////////////////////////////
void Moon::addTexCoord(float s, float t)
{
...
///////////////////////////////////////////////////////////////////////////////
void Moon::addIndices(unsigned int i1, unsigned int i2, unsigned int i3)
{
...
///////////////////////////////////////////////////////////////////////////////
std::vector<float> Moon::computeFaceNormal(float x1, float y1, float z1,  // v1
